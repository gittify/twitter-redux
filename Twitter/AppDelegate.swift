...
//        return true
        ...
        if User.currentUser != nil {
           ...
           // let vc = storyboard.instantiateViewController(withIdentifier: "TimelineNavigationViewController") as UIViewController
           window?.rootViewController = hamburgerViewController //vc
        }
